...
function MainLayoutInner({ children }) {
  ...
  return (
    <div className="min-h-screen bg-bg text-ink font-sans relative">
      {/* Masthead nav (wordmark + sections + search + controls) */}
      <TopNav />

      {/* Main Content Area — recedes behind the reader overlay */}
      <div
      ...
      {/* Section navigation — mobile only (desktop uses the top nav) */}
      <BottomNav />
